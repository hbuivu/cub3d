...
/*   Updated: 2023/08/30 20:36:48 by zsyyida          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		swap_sprite(t_main *main, int a, int b)
{
	...
	main->sprite->tmp_sprite = cub_calloc(1, sizeof(t_sprite), main);
	tmp = main->pl_to_sp_dist[a];
	main->pl_to_sp_dist[a] = main->pl_to_sp_dist[b];
	main->pl_to_sp_dist[b] = tmp;
	main->sprite->tmp_sprite = main->sprite[a];
	main->sprite[a] = main->sprite[b];
	main->sprite[b] = main->sprite->tmp_sprite;
	free (main->sprite->tmp_sprite);
}
...
void	init_sprite(t_main *main)
{
	...
	// free sprite later
	main->sprite_num = i;
	// do i need to calloc sprite array first?
}